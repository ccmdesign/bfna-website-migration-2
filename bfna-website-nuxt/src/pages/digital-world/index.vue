<template>
  <div>
    ...
    <div class="wrapper">
      ...
      <div v-if="updatesList && updatesList.length > 0" class="cards-section cards-section--updates cards-section--digital-world">
        ...
        <LegacyMoleculesCard
          ...
          :card="card"
        />
        <div class="cards-section__button cards-section--digital-world">
          <div id="more-articles-button" data-workstream="digital-world" style="width: max-content; margin: auto;">
...
const { data: workstreamsData } = useWorkstreams('digital-world')

const workstreamData = computed(() => {
  return workstreamsData.value?.['digital-world'] || null
})
