<template>
  <div>
    ...
    <div class="wrapper">
      ...
      <div v-if="updatesList && updatesList.length > 0" class="cards-section cards-section--updates cards-section--politics-society">
        ...
        <LegacyMoleculesCard
          ...
          :card="card"
        />
        <div class="cards-section__button cards-section--politics-society">
          <div id="more-articles-button" data-workstream="politics-society" style="width: max-content; margin: auto;">
...
const { data: workstreamsData } = useWorkstreams('politics-society')

const workstreamData = computed(() => {
  return workstreamsData.value?.['politics-society'] || null
})
...
useHead({
  title: computed(() => {
    if (!workstreamData.value) return 'Politics & Society | Bertelsmann Foundation'
