<template>
  <div>
    ...
    <div class="wrapper">
      ...
      <div v-if="updatesList && updatesList.length > 0" class="cards-section cards-section--updates cards-section--democracy">
        ...
        <LegacyMoleculesCard
          ...
          :card="card"
        />
        <div class="cards-section__button cards-section--democracy">
          <div id="more-articles-button" data-workstream="democracy" style="width: max-content; margin: auto;">
...
const { data: workstreamsData } = useWorkstreams('democracy')
