...
She raised the same doubt again on the footer:
...
Irene Braam is on the Board now. **What we need:** names, titles and photos for the
two new members.

Also outstanding, from the same round:

- **Bluesky profile URL** — we swapped Twitter for Bluesky as asked, but the link
  currently points nowhere.
- **Microsite addresses** for Indo-Pacific Nexus and Astropolitics — both are now
  marked as external microsites, both links are placeholders.
